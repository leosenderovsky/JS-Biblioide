...
let botonPrueba = document.getElementById('boton-vercatalogo')
botonPrueba.className = 'btn btn-primary btn-block'
botonPrueba.textContent = `VER CATÁLOGO`
botonPrueba.insertBefore = (textContent, libreria)
